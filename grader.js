...
var buildfn = function(file, checks) {
    console.error("buildfn");
    var response2console = function(result, response) {
	console.error("reponse2console");
...
if(require.main == module) {
	...
	var responsetoconsole = buildfn("localFile.html", program.checks);
	rest.get(program.url).on('complete', responsetoconsole);
    } else {
